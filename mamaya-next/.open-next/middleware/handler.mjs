...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `), Object.defineProperty(this, "__NEXT_ERROR_CODE", { value: "E1177", enumerable: false, configurable: true });
          ...
          if ("/middleware" === t10.page || "/src/middleware" === t10.page || "/proxy" === t10.page || "/src/proxy" === t10.page) {
            ...
            return e3().trace(eq.execute, { spanName: `middleware ${w2.method}`, attributes: { "http.target": w2.nextUrl.pathname, "http.method": w2.method } }, async () => {
              try {
                ...
                let u3 = tm(), c2 = await tw("/", w2.nextUrl.pathname, null), d3 = (a3 = w2.nextUrl, o3 = (e11) => {
                  ...
                  return { type: "request", phase: t11, implicitTags: o4, url: { pathname: i4.pathname, search: i4.search ?? "" }, rootParams: a4, get headers() {
                    ...
                    if (!h3.cookies) {
                      ...
                      e9(r12, e12), h3.cookies = eR.seal(e12);
                    }
                    return h3.cookies;
                  }, set cookies(value) {
                    h3.cookies = value;
                    ...
                    if (!h3.mutableCookies) {
                      ...
                      e9(r12, t12), h3.mutableCookies = t12;
                    }
                ...
                return await ex.run(p3, () => e7.run(d3, t10.handler, w2, x2));
              } finally {
                setTimeout(() => {
                  r11.dispatchClose();
                }, 0);
      ...
      class rf {
        ...
        async get(e10, t10) {
          ...
          if (t10.kind === tG.FETCH) {
            let r11 = e7.getStore(), n3 = r11 ? te(r11) : null;
            if (n3) {
      ...
      let rM = function(e10) {
        ...
        return t10;
      }({ HS256: rP(256), HS384: rP(384), HS512: rP(512), RS256: rN(256), RS384: rN(384), RS512: rN(512), PS256: rN(256, 32), PS384: rN(384, 48), PS512: rN(512, 64), ES256: rA("P-256", 256), ES384: rA("P-384", 384), ES512: rA("P-521", 512), EdDSA: rk(), Ed25519: rk(), "ML-DSA-44": rI(44), "ML-DSA-65": rI(65), "ML-DSA-87": rI(87) }), rj = new TextEncoder(), rD = new TextDecoder(), rL = new TextDecoder("utf-8", { fatal: true });
      function r$(e10) {
      ...
      let rU = "The input to be decoded is not correctly encoded.";
      function rq(e10) {
        if (Uint8Array.fromBase64) try {
          return Uint8Array.fromBase64("string" == typeof e10 ? e10 : rD.decode(e10), { alphabet: "base64url" });
        } catch (e11) {
          throw TypeError(rU, { cause: e11 });
        }
        let t10 = e10;
        if (t10 instanceof Uint8Array && (t10 = rD.decode(t10)), t10.includes("+") || t10.includes("/")) throw TypeError(rU);
      ...
      Symbol();
      let rF = { __proto__: null, b64: true }, rV = (e10, t10, ...r10) => function(e11, t11, ...r11) {
        if (r11.length > 2) {
          let t12 = r11.pop();
      ...
      }(`Key for the ${e10} algorithm must be `, t10, ...r10), rG = (e10) => {
      ...
      let rX = (e10) => e10[Symbol.toStringTag], rz = { __proto__: null, prime256v1: "P-256", secp384r1: "P-384", secp521r1: "P-521" };
      function rK(e10, t10, r10) {
        let i2 = (n ||= /* @__PURE__ */ new WeakMap()).get(e10);
        return r10 && (i2 ? i2[t10] = r10 : n.set(e10, { __proto__: null, [t10]: r10 })), r10 ?? i2?.[t10];
      }
      let rJ = async (e10, t10, r10) => rK(e10, r10.alg) ?? rK(e10, r10.alg, await rW(r10, { ...t10, alg: r10.alg }));
      async function rQ(e10, t10, r10) {
        let n2 = function(e11, t11, r11) {
          ...
          if (rH(t11) && "string" == typeof t11.kty) {
            if (i2 ? "oct" !== t11.kty || "string" != typeof t11.k : !(a2 ? "oct" !== t11.kty && ("AKP" === t11.kty && "string" == typeof t11.priv || "string" == typeof t11.d) : "oct" !== t11.kty && void 0 === t11.d && void 0 === t11.priv)) throw TypeError(i2 ? 'JSON Web Key for symmetric algorithms must have JWK "kty" (Key Type) equal to "oct" and the JWK "k" (Key Value) present' : `JSON Web Key for this operation must be a ${a2 ? "private" : "public"} JWK`);
            return ((e12, t12, r12) => {
              let { alg: n4 } = e12;
              if (void 0 !== t12.use) {
          ...
          if (!(rG(t11) || t11?.[Symbol.toStringTag] === "KeyObject")) throw TypeError(i2 ? rV(n3, t11, "CryptoKey", "KeyObject", "JSON Web Key", "Uint8Array") : rV(n3, t11, "CryptoKey", "KeyObject", "JSON Web Key"));
          if (i2) {
            if ("secret" !== t11.type) throw TypeError(`${rX(t11)} instances for symmetric algorithms must be of type "secret"`);
          } else {
            if ("secret" === t11.type) throw TypeError(`${rX(t11)} instances for asymmetric algorithms must not be of type "secret"`);
            ...
            if (("public" === t11.type || "private" === t11.type) && t11.type !== e12) {
              ...
              throw TypeError(`${rX(t11)} instances for asymmetric algorithm ${n4} must be of type "${e12}"`);
            }
          }
          return rG(t11) ? [1, t11] : [2, t11];
        }(e10, t10, r10);
        switch (n2[0]) {
          case 0:
          case 1:
          ...
          case 3: {
            let t11 = n2[1];
            if (t11.k) return rq(t11.k);
            if (!Object.isFrozen(t11)) {
              let { key_ops: e11 } = t11;
              Array.isArray(e11) && Object.freeze(e11), Object.freeze(t11);
            }
            return rJ(t11, t11, e10);
          }
          case 2: {
            let t11 = n2[1];
            if ("secret" === t11.type) return t11.export();
            if ("toCryptoKey" in t11 && "function" == typeof t11.toCryptoKey) return ((e11, t12) => {
              let r11 = rK(e11, t12.alg);
              if (r11) return r11;
              let n3 = "public" === e11.type, i2 = t12.usages[+!n3], { asymmetricKeyType: a2 } = e11, o2 = rz[e11.asymmetricKeyDetails?.namedCurve], s2 = t12.resolve?.({ crv: o2, asymmetricKeyType: a2 }) ?? t12.subtle;
              return rK(e11, t12.alg, e11.toCryptoKey(s2, n3, i2));
            })(t11, e10);
            return rJ(t11, t11.export({ format: "jwk" }), e10);
          }
        }
      }
      async function rY(e10, t10, r10) {
        let n2, { protected: i2, header: a2, payload: o2 } = e10, s2 = {};
        if (i2 && (s2 = function(e11, t11, r11) {
          let n3;
          try {
            n3 = JSON.parse(rL.decode(rq(e11)));
          } catch {
            throw new t11(r11);
          }
          if (!rH(n3)) throw new t11(r11);
          return n3;
        }(i2, rR, "JWS Protected Header is invalid")), void 0 !== a2) {
          if (!function(...e11) {
            ...
            return true;
          }(s2, a2)) throw new rR("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
          n2 = { ...s2, ...a2 };
        } else n2 = s2;
        let l2 = function(e11, t11, r11, n3, i3) {
          ...
          for (let t12 of n3.crit) {
            if (!(t12 in a3)) throw new rS(`Extension Header Parameter "${t12}" is not recognized`);
          ...
          return n3.crit;
        }(rR, rF, t10[1], s2, n2), u2 = true;
        if (l2.includes("b64") && "boolean" != typeof (u2 = s2.b64)) throw new rR('The "b64" (base64url-encode payload) Header Parameter must be a boolean');
        let { alg: c2 } = n2;
        if ("string" != typeof c2 || !c2) throw new rR('JWS "alg" (Algorithm) Header Parameter missing or invalid');
        if (t10[0] && !t10[0].has(c2)) throw new rx('"alg" (Algorithm) Header Parameter value not allowed');
        if (u2) {
          if ("string" != typeof o2) throw new rR("JWS Payload must be a string");
        } else if ("string" != typeof o2 && !(o2 instanceof Uint8Array)) throw new rR("JWS Payload must be a string or an Uint8Array instance");
        let d2 = false;
        "function" == typeof r10 && (r10 = await r10(s2, e10), d2 = true);
        let p2 = function(e11) {
          ...
          return t11;
        }(void 0 !== i2 ? r$(i2) : new Uint8Array(), r$("."), "string" == typeof o2 ? u2 ? t10[2] ??= function(e11, t11, r11) {
          try {
            return r$(e11);
          } catch {
            throw new r11(`The ${t11} is not a valid base64url string`);
          }
        }(o2, "payload", rR) : rj.encode(o2) : o2), f2 = rB(e10.signature, "signature", rR), g2 = await rQ(p2, r10, "verify");
        if (!await ry(p2, g2, f2, h2)) throw new rO();
        return [u2 ? rB(o2, "payload", rR) : "string" == typeof o2 ? rj.encode(o2) : o2, s2, u2, g2, d2];
      }
      async function rZ(e10, t10, r10) {
        if (e10 instanceof Uint8Array && (e10 = rD.decode(e10)), "string" != typeof e10) throw new rR("Compact JWS must be a string or Uint8Array");
        let { 0: n2, 1: i2, 2: a2, length: o2 } = e10.split(".");
        if (3 !== o2) throw new rR("Invalid Compact JWS");
        return rY({ payload: i2, protected: n2, signature: a2 }, t10, r10);
      }
      let r0 = { s: 1, m: 60, h: 3600, d: 86400, w: 604800, y: 31557600 }, r1 = /^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i, r2 = "check_failed";
      function r4(e10) {
        let t10 = r1.exec(e10);
        if (!t10 || t10[4] && t10[1]) throw TypeError("Invalid time period format");
        let r10 = Math.round(parseFloat(t10[2]) * r0[t10[3][0].toLowerCase()]);
      ...
      let r6 = (e10) => e10.includes("/") ? e10.toLowerCase() : `application/${e10.toLowerCase()}`;
      function r5(e10, t10, r10 = false) {
        let n2 = e10[t10];
        if (void 0 !== n2 || r10) {
      ...
      function r8(e10, t10) {
        throw new rw(`unexpected "${t10}" claim value`, e10, t10, r2);
      }
      async function r9(e10, t10, r10) {
        let n2 = await rZ(e10, [r10 && function(e11, t11) {
        ...
        let i2 = { payload: function(e11, t11, r11 = {}) {
          ...
          let a2;
          try {
            a2 = JSON.parse(rL.decode(t11));
          } catch {
          }
          if (!rH(a2)) throw new rC("JWT Claims Set must be a top-level JSON object");
          let { typ: o2 } = r11;
          if (o2 && ("string" != typeof e11.typ || r6(e11.typ) !== r6(o2))) throw new rw('unexpected "typ" JWT header value', a2, "typ", r2);
          ...
          void 0 === l2 || (Array.isArray(l2) ? l2 : [l2]).includes(a2.iss) || r8(a2, "iss"), void 0 !== u2 && a2.sub !== u2 && r8(a2, "sub"), void 0 === c2 || (n3 = a2.aud, i3 = "string" == typeof c2 ? [c2] : c2, "string" == typeof n3 ? i3.includes(n3) : !!Array.isArray(n3) && i3.some((e12) => n3.includes(e12))) || r8(a2, "aud");
          ...
          let { currentDate: g2 } = r11, m2 = r3("currentDate option", Math.floor((g2 || /* @__PURE__ */ new Date()).getTime() / 1e3)), v2 = r5(a2, "iat", void 0 !== d2), b2 = r5(a2, "nbf");
          if (void 0 !== b2 && b2 > m2 + f2) throw new rw('"nbf" claim timestamp check failed', a2, "nbf", r2);
          let y2 = r5(a2, "exp");
          if (void 0 !== y2 && y2 <= m2 - f2) throw new rE('"exp" claim timestamp check failed', a2, "exp", r2);
          if (void 0 !== d2) {
            let e12 = m2 - v2;
            if (e12 - f2 > ("number" == typeof d2 ? d2 : r4(d2))) throw new rE('"iat" claim timestamp check failed (too far in the past)', a2, "iat", r2);
            if (e12 < 0 - f2) throw new rw('"iat" claim timestamp check failed (it should be in the past)', a2, "iat", r2);
          }
          return a2;
        }(n2[1], n2[0], r10), protectedHeader: n2[1] };
        return "function" == typeof t10 ? { ...i2, key: n2[3] } : i2;
      }
      let r7 = process.env.SESSION_SECRET || "fallback-secret-mamaya-2026", ne = new TextEncoder().encode(r7);
      async function nt(e10) {
        let { pathname: t10 } = e10.nextUrl;
        if (t10.startsWith("/admin")) {
          let r10 = e10.cookies.get("admin_session")?.value;
          if (!t10.startsWith("/admin/login") && !r10) return ec.redirect(new URL("/admin/login", e10.url));
          if (r10) try {
            if (await r9(r10, ne, { algorithms: ["HS256"] }), t10.startsWith("/admin/login")) return ec.redirect(new URL("/admin", e10.url));
            return ec.next();
          } catch (r11) {
            if (!t10.startsWith("/admin/login")) return ec.redirect(new URL("/admin/login", e10.url));
          }
        }
        return ec.next();
      }
      e.s(["config", 0, { matcher: ["/admin/:path*"] }, "middleware", 0, nt], 99446);
      let nr = { ...e.i(99446) }, nn = "/middleware", ni = nr.middleware || nr.default;
      if ("function" != typeof ni) throw new class extends Error {
        constructor(e10) {
          super(e10), Object.defineProperty(this, "__NEXT_ERROR_CODE", { value: "E394", enumerable: false, configurable: true }), this.stack = "";
        }
      }(`The Middleware file "${nn}" must export a function named \`middleware\` or a default function.`);
      let na = async (e10) => tT({ ...e10, IncrementalCache: rf, incrementalCacheHandler: null, page: nn, handler: async (...e11) => {
        try {
          return await ni(...e11);
        } catch (i2) {
      ...
      async function no(e10, t10) {
        let r10 = await na({ request: { url: e10.url, method: e10.method, headers: x(e10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: nn }, body: "GET" !== e10.method && "HEAD" !== e10.method ? e10.body ?? void 0 : void 0, waitUntil: t10.waitUntil, requestMeta: t10.requestMeta, signal: t10.signal || new AbortController().signal } });
        return null == t10.waitUntil || t10.waitUntil.call(t10, r10.waitUntil), r10.response;
      }
      e.s(["default", 0, na, "handler", 0, no], 42738);
    }]);
  }
});
